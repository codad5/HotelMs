<div class="w-full h-full">
    <div class="w-full h-1/5 text-center py-4">
        <h3 class="text-slate-800">Hotel Name</h3>
    </div>
    <div class="w-full h-4/5 text-center py-3">
        <ul class="w-full text-center px-0 text-lg font-medium space-y-4">
