                ...
                <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-3 gap-6">
                        <div class="col-span-3 sm:col-span-2">
                            {{ Form::label('email', 'Email', ['class' => 'block text-sm font-medium
                            text-gray-700']) }}
                            <div class="mt-1 flex rounded-md shadow-sm">
                                ...
                                {{ Form::email('email', '', ['class' => 'block w-full flex-1 rounded-none rounded-r-md
                    ...
                    <div class="grid grid-cols-3 gap-6">
                        <div class="col-span-3 sm:col-span-2">
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                <span
                                    class="inline-flex items-center rounded-l-md border border-r-0 border-gray-300 bg-gray-50 px-3 text-sm text-gray-500">*</span>
                                {{ Form::password('password', ['class' => 'block w-full flex-1 rounded-none rounded-r-md
                                border-gray-300
